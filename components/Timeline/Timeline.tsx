                ...
                <li className="relative grid grid-cols-2 group odd:-me-3 even:-ms-3">
                    <div className="relative flex items-start gap-1.5 lg:gap-4 group-odd:flex-row-reverse group-odd:text-right group-even:order-last">
                        ...
                        <div className="-mt-2">
                            ...
                            <Image className='aspect-3/4 lg:aspect-video' src={"/images/banner/banner1.jpg"} alt='Image' width={1920} height={1080} />
                            <Link href={""} className='block mt-3 tracking-widest text-orange-500 uppercase font-montserrat'>Details</Link>
                        </div>
                    </div>

...
const Footer = () => {
    return (
        <footer className="px-4 pt-12 pb-6 tracking-wide text-white bg-gray-800">
            <div className="text-center">
                ...
                <div className="mt-12">
                    ...
                    <ul className="flex flex-wrap justify-center gap-4 mt-6 gap-x-6 ga-y-3">
                        <li>
                            <a href='javascript:void(0)'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-blue-600" viewBox="0 0 49.652 49.652">
                ...
                <div className="pt-6 mt-12 border-t border-gray-600">
                    <p className="text-[15px] text-slate-300">© TheSundarbans. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
